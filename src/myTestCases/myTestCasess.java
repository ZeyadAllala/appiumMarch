...
public class myTestCasess {
	...
	public void pressonAllNumbersOnlyNumbers() throws MalformedURLException {
		...
		for (int i = 0; i < allNumbers.size(); i++) {
			if (allNumbers.get(i).getAttribute("resource-id").contains("2")
					|| allNumbers.get(i).getAttribute("resource-id").contains("4")
					|| allNumbers.get(i).getAttribute("resource-id").contains("6")
					|| allNumbers.get(i).getAttribute("resource-id").contains("8")
					|| allNumbers.get(i).getAttribute("resource-id").contains("0")) {
